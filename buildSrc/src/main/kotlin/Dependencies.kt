...
object AppConstant {
    const val applicationPackage = "reprator.paypay"
    const val name = "PayPay"
    const val host = "http://api.currencylayer.com/"
    const val hostConstant = "HOST"
    const val buildConfigConstant_apiKey = "PAYPAY_CURRENCYLAYER_API_KEY"
...
object AppModules {
    ...
    const val moduleCurrencyConverter = ":currencyConverter"
}
